...
public class RezervareBuilderV2 implements AbstractBuilder{
    ...
    //incalcam principiul DRY pt ca avem aceleasi atribute in 2 parti diferite
    ...
    public RezervareBuilderV2(){
        ...
        this.genMuzica = "k-pop";
    }

    @Override
    public Rezervare build() {
        return new Rezervare(codRezervare,areMancare,
                areScaunErgonomic,areBautura,areMuzicaAmbientala,genMuzica);
    }
